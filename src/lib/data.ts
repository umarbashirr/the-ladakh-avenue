...
export const rooms = [
  {
    ...
    amenities: [
      ...
      {
        label: "OnePlus LED TV 42 Inches, fully Wi-Fi enabled",
        icon: "/icons/tv.svg",
      },
      { label: "High-speed 5G Wi-Fi", icon: "/icons/wifi.svg" },
      {
        label: "24/7 Hot and Cold Running Water",
        icon: "/icons/hot-water.svg",
      },
      {
        label: "Private Balcony with Mountain View",
        icon: "/icons/balcony.svg",
      },
      { label: "Separate Living Area", icon: "/icons/living-area.svg" },
      { label: "En-suite Bathroom", icon: "/icons/bathroom.svg" },
      { label: "Wardrobe with Double Curtain", icon: "/icons/wardrobe.svg" },
      { label: "Luggage Table", icon: "/icons/luggage.svg" },
      { label: "Mirror with Vanity Lighting", icon: "/icons/mirror.svg" },
      { label: "Iron on Request", icon: "/icons/iron.svg" },
      { label: "Mini Refrigerator", icon: "/icons/fridge.svg" },
      {
        label: "Tea/Coffee Maker / Electric Kettle with Tea and Coffee Sachets",
        icon: "/icons/tea-coffee.svg",
      },
      {
        label: "Complimentary Daily Mineral Water (2 Bottles Each Day)",
        icon: "/icons/water.svg",
      },
      { label: "Bath Towels and Hand Towels", icon: "/icons/towel.svg" },
      { label: "Shampoo and Body Wash", icon: "/icons/bath-essentials.svg" },
      { label: "Dental Kit", icon: "/icons/dental-kit.svg" },
      { label: "Shaving Kit + Comb", icon: "/icons/shaving-kit.svg" },
      { label: "Hairdryer on Request", icon: "/icons/hairdryer.svg" },
      { label: "Daily Housekeeping", icon: "/icons/housekeeping.svg" },
      { label: "Intercom", icon: "/icons/intercom.svg" },
      { label: "Seating Area", icon: "/icons/seating.svg" },
    ],
  ...
  items: [
    {
      ...
      title: "Free Wifi",
      desc: "Stay connected throughout your stay with our complimentary high-speed Wi-Fi, available in all rooms and public areas.",
    },
    {
      image: "/icons/laundry.svg",
      title: "Laundry & Dry Cleaning",
      desc: "Enjoy the convenience of our professional laundry services, ensuring you always have fresh and clean attire.",
    },
    {
      title: "Travel Desk",
      image: "/icons/airport-shuttle.svg",
      desc: "Our travel desk is right next to reception to help you with all your queries related to travel.",
    },
    {
      title: "Private Parking",
      image: "/icons/parking.svg",
      desc: "Benefit from our secure private parking facilities, providing peace of mind and easy access to your vehicle. ",
    },
  ],
};
